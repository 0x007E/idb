[![Version: 1.0 Release](https://img.shields.io/badge/Version-1.0%20Release-green.svg)](https://github.com/0x007e/idb) ![Build](https://github.com/0x007e/idb/actions/workflows/release.yml/badge.svg) [![License CC By-NC-SA](https://img.shields.io/badge/Hardware-CC--BY--NC--SA--4.0-lightgrey)](https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode)
...
| BoM | [xlsx](https://github.com/0x007E/idb/releases/latest/download/bom.xlsx) / [html](https://github.com/0x007E/idb/releases/latest/download/bom.html)          | Bill of Material as Excel/interactive HTML |
...
| Mechanical | [zip](https://github.com/0x007E/idb/releases/latest/download/freecad.zip) / [tar](https://github.com/0x007E/idb/releases/latest/download/freecad.tar.gz) | FreeCAD/Housing and PCB (STEP/STL) files     |
...
![Top Layer](https://github.com/0x007E/idb/releases/latest/download/top.kicad.png)

### Bottom Layer

![Bottom Layer](https://github.com/0x007E/idb/releases/latest/download/bottom.kicad.png)

# Additional Information

| Type       | Link                                                  | Description                                 |
|:----------:|:-----------------------------------------------------:|:--------------------------------------------|
| CD40106    | [pdf](https://www.ti.com/lit/ds/symlink/cd40106b.pdf) | CD40106B CMOS Hex Schmitt-Trigger Inverters |
